...
public class JDateChooser extends JPanel implements ActionListener,
	...
	public JDateChooser(JCalendar jcal, Date date, String dateFormatString,
		...
		//ImageIcon icon = new ImageIcon("images/JDateChooserIcon.gif");
	...
	public static void main(String[] s) {
        ...
        JCalendar cal = new JCalendar(null, null, true, false);
		JDateChooser dateChooser = new JDateChooser(cal, new Date(), null, null);
